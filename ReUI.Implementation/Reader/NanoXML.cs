...
namespace ReUI.Implementation
{
    ...
    /// </summary>
    public class NanoXMLDocument : NanoXMLBase, IXmlDocument
    {
    ...
    /// </summary>
    public class NanoXMLNode : NanoXMLBase, IXmlNode
    {
        ...
        /// List of subelements
        /// </summary>
        public IEnumerable<IXmlNode> SubNodes
        {
            get { return subNodes.Cast<IXmlNode>(); }
        }
        /// <summary>
        /// List of attributes
        /// </summary>
        ...
        {
            get { return attributes.Cast<IXmlAttribute>(); }
        }
        /// <summary>
    ...
    /// </summary>
    public class NanoXMLAttribute : IXmlAttribute
    {
        private string name;
        private string value;
        /// <summary>
